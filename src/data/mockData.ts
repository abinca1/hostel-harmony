...
export const mockRooms: Room[] = [
  ...
  },
  {
    ...
    status: "available",
    monthlyRent: 8000,
    beds: [{ id: "bed-103-1", number: "1", roomId: "room-103" }],
    amenities: ["AC", "Attached Bathroom", "WiFi"],
  },
  {
    id: "room-104",
    ...
    monthlyRent: 15000,
    beds: [
      { id: "bed-104-1", number: "1", roomId: "room-104" },
      { id: "bed-104-2", number: "2", roomId: "room-104" },
      { id: "bed-104-3", number: "3", roomId: "room-104" },
    ],
  ...
  },
  {
    ...
    monthlyRent: 12000,
    beds: [
      { id: "bed-105-1", number: "1", roomId: "room-105" },
      { id: "bed-105-2", number: "2", roomId: "room-105" },
    ],
    amenities: ["AC", "Attached Bathroom", "WiFi"],
  },
  // Block A, Floor 2
  ...
  },
  {
    ...
    monthlyRent: 12500,
    beds: [
      { id: "bed-202-1", number: "1", roomId: "room-202" },
      { id: "bed-202-2", number: "2", roomId: "room-202" },
    ],
    amenities: ["AC", "Attached Bathroom", "WiFi", "Balcony"],
  },
  {
  ...
  },
  {
    ...
    beds: [
      ...
      },
      {
        ...
        number: "2",
        roomId: "room-204",
        residentId: "resident-7",
      },
      { id: "bed-204-3", number: "3", roomId: "room-204" },
      { id: "bed-204-4", number: "4", roomId: "room-204" },
    ],
    amenities: ["Fan", "Common Bathroom", "Locker"],
  },
  // Block A, Floor 3
  {
    id: "room-301",
    ...
    status: "available",
    monthlyRent: 9000,
    beds: [{ id: "bed-301-1", number: "1", roomId: "room-301" }],
    amenities: ["AC", "Attached Bathroom", "WiFi", "Terrace Access"],
  },
  {
    id: "room-302",
    number: "A-302",
    ...
    beds: [
      ...
      { id: "bed-302-2", number: "2", roomId: "room-302" },
    ],
    amenities: ["AC", "Attached Bathroom", "WiFi", "Terrace Access"],
  },
  // Block B rooms
  {
    ...
    amenities: ["Fan", "Attached Bathroom", "WiFi"],
  },
  {
    id: "room-b102",
    number: "B-102",
    ...
    monthlyRent: 11000,
    beds: [
      { id: "bed-b102-1", number: "1", roomId: "room-b102" },
      { id: "bed-b102-2", number: "2", roomId: "room-b102" },
    ],
    amenities: ["Fan", "Common Bathroom", "WiFi"],
  },
];
...
export const mockPayments: Payment[] = [
  ...
  },
  {
    ...
    dueDate: "2024-02-05",
    month: "February 2024",
    description: "Paid ₹3000, ₹2000 pending",
  },
  {
    id: "pay-7",
    residentId: "resident-1",
...
export const mockMealPlans: MealPlan[] = [
  ...
  },
  {
    id: "plan-breakfast",
    name: "Breakfast Only",
    description: "Only breakfast included",
  ...
  },
  {
    id: "plan-none",
    name: "No Meals",
    description: "Opt out of mess facilities",
    mealsIncluded: [],
    monthlyPrice: 0,
    isActive: true,
  },
...
export const mockMenuItems: MenuItem[] = [
  ...
  {
    id: "menu-3",
    name: "Chapati, Paneer Curry, Rice, Dal",
    mealType: "dinner",
    dayOfWeek: 1,
    dietaryTags: ["vegetarian"],
    calories: 600,
  ...
  {
    id: "menu-5",
    name: "Rice, Sambar, Chicken Curry (Non-Veg)",
    mealType: "lunch",
    dayOfWeek: 2,
    dietaryTags: ["non-veg"],
    calories: 700,
  ...
  {
    id: "menu-8",
    name: "Biryani (Veg/Non-Veg), Raita",
    mealType: "lunch",
    dayOfWeek: 3,
    dietaryTags: ["non-veg"],
    calories: 750,
